        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Maple Trade Corp - Your trusted partner in eco-friendly food service solutions
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 md:p-12 mb-8">
          ...
          <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
            ...
            <p>
              With over <span className="font-semibold text-[#1c51a3]">15+ years of experience</span> in the distribution business, we take pride in our 
        ...
        <div className="bg-blue-600 rounded-lg p-8 md:p-12 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link 
              href="/contact"
              className="inline-block bg-transparent border-2 border-white text-white px-8 py-3 rounded-md font-semibold hover:bg-white hover:text-blue-600 transition-colors"
            >
              Contact Us
            </Link>
          </div>
