...
export default function ClipinRoundPage() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            ...
            <div className="flex flex-col">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">
                Clipin Round Containers
              </h1>
              
              <div className="mb-6">
                <p className="text-gray-600 text-lg leading-relaxed">
                  Premium Clipin round plastic containers designed for superior food storage and presentation. 
                  These high-quality containers feature the innovative Clipin closure system for secure sealing. 
                  Perfect for delis, restaurants, meal prep services, and takeout operations. Available in 
                  capacities ranging from 8 oz to 48 oz.
                </p>
              </div>
              ...
              <div className="mt-auto pt-6 border-t border-gray-200">
                <AddToListButton
                  productName="Clipin Round Containers"
                  brand="HD"
                  category="Clipin Round Containers"
                  slug="clipin/round"
                  brandSlug="hd"
...
export async function generateMetadata() {
  return {
    title: 'Clipin Round Containers - HD Products - Maple Trade Corp',
    description: 'Premium Clipin round containers from 8oz to 48oz. Featuring innovative Clipin closure system for secure sealing.',
  };
}
