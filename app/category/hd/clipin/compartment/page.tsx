...
export default function ClipinCompartmentPage() {
  ...
  const sizeOptions = [
    { 
      ...
      description: '30 oz Plastic Rectangular 2-Compartment Containers',
      caseQty: '150 SETS',
      caseWeight: '18.5 lb',
      palletCount: '50',
      tiHi: '10 x 5'
    ...
    { 
      ...
      itemNo: 'HDCO33',
      size: '30 oz - 3 Comp',
      dimensions: '9.1" x 7.1" x 2"',
      description: '30 oz Plastic Round 3-Compartment Containers',
      caseQty: '150 SETS',
      caseWeight: '22.4 lb',
      palletCount: '40',
      tiHi: '8 x 5'
    ...
    { 
      ...
      description: '40 oz Plastic Round 3-Compartment Containers',
      caseQty: '150 SETS',
      caseWeight: '26.5 lb',
      palletCount: '30',
      tiHi: '6 x 5'
    ...
    { 
      ...
      size: '42 oz - 3 Comp',
      dimensions: '9.1" x 7.1" x 2"',
      description: '42 oz Plastic Rectangular 3-Compartment Containers',
      caseQty: '150 SETS',
      caseWeight: '25.6 lb',
      palletCount: '40',
      tiHi: '8 x 5'
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-500 mb-6">
          ...
          <span>/</span>
          <span className="text-gray-700 font-medium">Compartment Containers</span>
        </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            ...
            <div className="relative h-96 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg overflow-hidden">
              <Image
                ...
                alt="Clipin Compartment Containers"
                fill
            ...
            <div className="flex flex-col">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">
                Clipin Compartment Containers
              </h1>
              
              <div className="mb-6">
                <p className="text-gray-600 text-lg leading-relaxed">
                  Premium Clipin multi-compartment containers designed for portion control and meal variety. 
                  Featuring the innovative Clipin closure system for secure sealing. Perfect for restaurants, 
                  meal prep services, and catering operations. These containers feature separate compartments 
                  to keep different food items organized and fresh.
                </p>
              </div>
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-600">
                  ...
                  <li>2 and 3-compartment options</li>
                  <li>Perfect for portion control</li>
                  <li>Food-safe plastic materials</li>
                  <li>Prevents food mixing</li>
                  <li>Ideal for meal prep and takeout</li>
                </ul>
              </div>
              {/* Add to List Button */}
              <div className="mt-auto pt-6 border-t border-gray-200">
                <AddToListButton
                  productName="Clipin Compartment Containers"
                  brand="HD"
                  category="Clipin Compartment Containers"
                  slug="clipin/compartment"
                  brandSlug="hd"
...
export async function generateMetadata() {
  return {
    title: 'Clipin Compartment Containers - HD Products - Maple Trade Corp',
    description: 'Premium Clipin 2 and 3-compartment containers. Featuring innovative Clipin closure system for secure sealing and portion control.',
  };
}
