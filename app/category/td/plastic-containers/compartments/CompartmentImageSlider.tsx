...
const productImages = [
  {
    src: '/MTC_TD_PP/MTC TD no bg pics/td chicken.png',
    alt: 'TD Chicken'
  },
  {
    src: '/MTC_TD_PP/MTC TD no bg pics/3 comp closed.png',
    alt: '3 Comp Closed'
  },
  {
  ...
  {
    src: '/MTC_TD_PP/MTC TD no bg pics/two comp close.png',
    alt: 'Two Comp Close'
  },
  {
    src: '/MTC_TD_PP/MTC TD no bg pics/two comp open.png',
    alt: 'Two Comp Open'
  }
];

export default function CompartmentImageSlider() {
