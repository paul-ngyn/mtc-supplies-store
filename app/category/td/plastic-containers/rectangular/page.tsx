...
export default function TDRectangularContainersPage() {
  ...
  const sizeOptions = [
    { 
      ...
      itemNo: 'F6412',
      size: '6" x 4"',
      dimensions: '6" x 4.75" x 1"',
      description: '6" x 4" Plastic Rectangular Containers',
      caseQty: '150 SETS',
      caseWeight: '8.7 lb',
      palletCount: '114',
      tiHi: '19 x 6'
    ...
    { 
      ...
      itemNo: 'F7516',
      size: '7" x 5" Low',
      dimensions: '8" x 5.25" x 1.25"',
      description: '7" x 5" Low Plastic Rectangular Containers',
      caseQty: '150 SETS',
      caseWeight: '12 lb',
      palletCount: '90',
      tiHi: '15 x 6'
    ...
    { 
      ...
      itemNo: 'F7524',
      size: '7" x 5" High',
      dimensions: '8" x 5.25" x 1.5"',
      description: '7" x 5" High Plastic Rectangular Containers',
      caseQty: '150 SETS',
      caseWeight: '12.5 lb',
      palletCount: '90',
      tiHi: '15 x 6'
    ...
    { 
      ...
      description: '9" x 6" Low Plastic Rectangular Containers',
      caseQty: '150 SETS',
      caseWeight: '14 lb',
      palletCount: '60',
      tiHi: '10 x 6'
    ...
    { 
      ...
      itemNo: 'F9632',
      size: '9" x 6" Medium',
      dimensions: '8.75" x 6" x 1.75"',
      description: '9" x 6" Medium Plastic Rectangular Containers',
      caseQty: '150 SETS',
      caseWeight: '14.7 lb',
      palletCount: '60',
      tiHi: '10 x 6'
    ...
    { 
      ...
      itemNo: 'F9638',
      size: '9" x 6" High',
      dimensions: '8.75" x 6" x 2"',
      description: '9" x 6" High Plastic Rectangular Containers',
      caseQty: '150 SETS',
      caseWeight: '15.5 lb',
      palletCount: '60',
      tiHi: '10 x 6'
    ...
    { 
      ...
      itemNo: 'F10648',
      size: '10" x 6"',
      dimensions: '10.5" x 7.25" x 1.63"',
      description: '10"x6" Rectangular Containers',
      caseQty: '150 SETS',
      caseWeight: '26.5 lb',
      palletCount: '30',
      tiHi: '6 X 5'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            ...
            <div className="flex flex-col">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">
                Plastic Rectangular Containers
              </h1>
              
              <div className="mb-6">
                <p className="text-gray-600 text-lg leading-relaxed">
                  Premium plastic rectangular containers designed for versatile food storage and takeout. 
                  Perfect for restaurants, delis, catering services, and food prep operations. These 
                  containers offer excellent space efficiency and are available in multiple sizes and 
                  depths to suit various food applications.
                </p>
              </div>
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-600">
                  ...
                  <li>Multiple sizes and depths available</li>
...
export async function generateMetadata() {
  return {
    title: 'Plastic Rectangular Containers - TD Products - Maple Trade Corp',
    description: 'Premium plastic rectangular containers in multiple sizes. Perfect for takeout, meal prep, and food storage.',
  };
}
