...
const productImages = [
  {
    src: '/MTC_TD_PP/MTC TD no bg pics/1 comp close.png',
    alt: '1 Comp Close 1'
  },
  {
  ...
  {
    src: '/MTC_TD_PP/MTC TD no bg pics/1 comp closed 2.png',
    alt: '1 Comp Close 2'
  },
  {
    src: '/MTC_TD_PP/MTC TD no bg pics/1 comp open 2.png',
    alt: '1 Comp Open 2'
  },
  {
...
export default function RectangularImageSlider() {
