...
export default function BioBoxesWhitePage() {
  ...
  const sizeOptions = [
    { 
      ...
      size: '#1 - 28 oz',
      dimensions: '5" x 4"',
      description: '#1 28 oz White Paper Box',
      caseQty: '450 PCS',
      caseWeight: '22 lb',
      palletCount: '20',
      tiHi: '5 x 4'
    ...
    { 
      ...
      description: '#2 48 oz White Paper Box',
      caseQty: '200 PCS',
      caseWeight: '18 lb',
      palletCount: '20',
      tiHi: '5 x 4'
    ...
    { 
      ...
      size: '#3 - 64 oz',
      dimensions: '8.5" x 6.25"',
      description: '#3 64 oz White Paper Box',
      caseQty: '200 PCS',
      caseWeight: '23 lb',
      palletCount: '20',
      tiHi: '5 x 4'
    ...
    { 
      ...
      size: '#4 - 80 oz',
      dimensions: '8.5" x 6.25"',
      description: '#4 80 oz White Paper Box',
      caseQty: '160 PCS',
      caseWeight: '23 lb',
      palletCount: '20',
      tiHi: '5 x 4'
    ...
    { 
      ...
      description: '#8 48 oz White Paper Box',
      caseQty: '300 PCS',
      caseWeight: '27 lb',
      palletCount: '20',
      tiHi: '5 x 4'
            ...
            <div className="flex flex-col">
              ...
              <div className="mb-6">
                <p className="text-gray-600 text-lg leading-relaxed">
                  Eco-friendly white paper bio boxes designed for sustainable food packaging with a clean, professional 
                  appearance. These bright white boxes are perfect for takeout, food service, and businesses looking 
                  for an elegant presentation. Made from renewable materials, they offer excellent durability while 
                  maintaining an environmentally responsible footprint. Available in multiple sizes from 28 oz to 80 oz.
                </p>
              </div>
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-600">
                  <li>Clean white color for premium presentation</li>
              ...
              <div className="mt-auto pt-6 border-t border-gray-200">
                <AddToListButton
                  productName="White Bio Boxes"
                  brand="TKN"
                  category="White Bio Boxes"
                  slug="bio-boxes/white"
                  brandSlug="tkn"
                  image="/TKN.png"
...
export async function generateMetadata() {
  return {
    title: 'White Bio Boxes - TKN Products - Maple Trade Corp',
    description: 'Eco-friendly white paper bio boxes from 28oz to 80oz. Sustainable food packaging with premium presentation.',
  };
}
