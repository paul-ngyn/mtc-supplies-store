...
export default function FoodPailsKraftPage() {
  ...
  const sizeOptions = [
    { 
      ...
      description: 'Food Pail Box Kraft Brown 8 oz',
      caseQty: '360 PCS',
      caseWeight: '9.25 lb',
      palletCount: '72',
      tiHi: '12 x 6'
    ...
    { 
      ...
      description: 'Food Pail Box Kraft Brown 16 oz',
      caseQty: '360 PCS',
      caseWeight: '14.08 lb',
      palletCount: '42',
      tiHi: '6 x 7'
    ...
    { 
      ...
      description: 'Food Pail Box Kraft Brown 26 oz',
      caseQty: '360 PCS',
      caseWeight: '19.58 lb',
      palletCount: '30',
      tiHi: '6 x 5'
    ...
    { 
      ...
      description: 'Food Pail Box Kraft Brown 32 oz',
      caseQty: '360 PCS',
      caseWeight: '22.66 lb',
      palletCount: '24',
      tiHi: '6 x 4'
    ...
    { 
      ...
      description: 'Food Pail Box Kraft Brown 64 oz',
      caseQty: '360 PCS',
      caseWeight: '39.68 lb',
      palletCount: '12',
      tiHi: '3 x 4'
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            ...
            <div className="relative h-96 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg overflow-hidden">
              <Image
                src="/TKN.png"
                alt="Kraft Food Pails - Heavy-Duty Storage Containers"
                title="TKN Kraft Food Pails - Bulk Food Storage Solution"
                fill
            ...
            <div className="flex flex-col">
              ...
              <div className="mb-6">
                <p className="text-gray-600 text-lg leading-relaxed">
                  Eco-friendly kraft brown food pail boxes designed for Asian takeout, noodles, rice dishes, and more. 
                  These traditional-style pails feature a natural kraft brown finish and are perfect for restaurants, 
                  food trucks, and takeout operations. Made from sustainable materials, they offer excellent leak 
                  resistance and durability. Available in sizes from 8 oz to 64 oz.
                </p>
              </div>
              ...
              <div className="mt-auto pt-6 border-t border-gray-200">
                <AddToListButton
                  productName="Kraft Food Pails"
                  brand="TKN"
                  category="Kraft Food Pails"
                  slug="food-pails/kraft"
                  brandSlug="tkn"
                  image="/TKN.png"
...
export async function generateMetadata() {
  return {
    title: 'Kraft Food Pails - TKN Products - Maple Trade Corp',
    description: 'Eco-friendly kraft food pail boxes from 8oz to 64oz. Perfect for Asian takeout, noodles, and rice dishes.',
  };
}
