...
const productImages = [
  {
    src: '/MTC_TKN_PP/MTC_FOOD_PAIL_KRAFT_BG-removebg.png',
    alt: 'Food Pail - Kraft',
    label: 'Kraft',
  },
  {
    src: '/MTC_TKN_PP/MTC-FOODPAIL_WHITE_BG-removebg-preview.png',
    alt: 'Food Pail - White',
    label: 'White',
  },
];

export default function FoodPailImageSlider() {
