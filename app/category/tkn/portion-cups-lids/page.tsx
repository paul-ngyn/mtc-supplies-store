...
// Portion Cups & Lids subcategories
const portionCupsSubcategories = [
  {
    id: 1,
    name: 'Portion Cups',
    slug: 'portion-cups',
...
export default function PortionCupsLidsPage() {
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex flex-col items-center justify-center space-y-4">
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600">
                Complete portion cup solutions for your food service needs
              </p>
              <div className="mt-4">
                <Link 
                  href="/brands"
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {portionCupsSubcategories.map((subCategory) => (
            <Link
              key={subCategory.id}
...
export async function generateMetadata() {
  return {
    title: 'Portion Cups & Lids - TKN Products - Maple Trade Corp',
    description: 'Browse our selection of portion cups and lids for food service and catering needs',
  };
}
