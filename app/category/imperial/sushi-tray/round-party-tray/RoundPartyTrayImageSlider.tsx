...
const productImages = [
  {
    src: '/MTC_IMP_PP/MTC IMPERIAL no bg/sushitrayroundhalf.png',
    alt: 'Round sushi tray half'
  },
  {
    src: '/MTC_IMP_PP/MTC IMPERIAL no bg/sushitrayroundopen.png',
    alt: 'Round sushi tray open'
  },
  {
    src: '/MTC_IMP_PP/MTC IMPERIAL no bg/sushitrayroundclosed.png',
    alt: 'Round sushi tray closed'
  }
];

export default function RoundPartyTrayImageSlider() {
