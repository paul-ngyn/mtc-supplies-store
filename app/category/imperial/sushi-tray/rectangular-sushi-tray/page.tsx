        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            ...
            <div className="relative h-96 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg overflow-hidden">
              <Image
                src="/demo.png"
                alt="Rectangular Sushi Tray Black and Gold"
                fill
...
export async function generateMetadata() {
  return {
    title: 'Rectangular Sushi Tray Black and Gold - Imperial Products - Maple Trade Corp',
    description: 'Premium rectangular sushi trays in black and gold. Perfect for sushi presentation, takeout, and catering services.',
  };
}
